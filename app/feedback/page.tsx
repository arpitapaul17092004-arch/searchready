...
/**
 * Tester / user feedback page, backed by Netlify Forms (free tier, 100
 * submissions/month). The static hidden form below is what Netlify's
 * deploy scanner detects; the interactive form POSTs the same fields
 * urlencoded to "/" with `form-name`.
 */
...
export default function FeedbackPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Static form so Netlify registers it at deploy time. */}
      ...
      >
        ...
        <p className="hidden">
          <label>
            Leave this field empty: <input name="bot-field" /> (spam trap)
          </label>
        </p>
